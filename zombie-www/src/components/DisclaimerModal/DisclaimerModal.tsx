    ...
    if (step === 'disclaimer') {
      return (
        <div>
          ...
          <p>✅ New vote has started, we will suspend all zombie farming activities until Dice farming starts. (Except DAI_ZOMBIE_UNI_LP pool)<br/><br/> <span style={{color: "red"}}>⚠️ The current scheduled farming suspension date is: 2020/09/04 10:00:00 (UTC+0) Please withdraw your tokens before the suspension.</span></p>
          ...
          🙌 Be mindful of the zombies by your side!</p>
        </div>
      )
    } else {
      return (
